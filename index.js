...
// console.log(result)
// fs.writeFileSync('removedStartOfLines.txt', result);
...
result = result.replace(modelNameRegex, (math, capture) => {
  const capitalized = math.replace(/(^\w{1})|(\s{1}\w{1})/g, match => match.toUpperCase());
